...
class TestBatchConversionIntegration:
    ...
    def test_batch_mode_outputs_to_input_folder_by_default(self, tmp_path):
        ...
        source_cci = test_ccis / "test-01-nocrypt.cci"
    ...
    def test_batch_mode_with_custom_output_directory(self, tmp_path):
    ...
    def test_batch_mode_ignores_non_cci_files(self, tmp_path):
    ...
    def test_batch_mode_handles_3ds_extension(self, tmp_path):
    ...
    def test_batch_mode_continues_on_conversion_error(self, tmp_path):
...
class TestBatchModeWithOptions:
    ...
    @pytest.fixture
    def batch_folder_with_cci(self, tmp_path):
